...
<<map, dev='pdf', echo=F,out.width='1\\textwidth',fig.align='center',fig.keep='last'>>=

### Map PLOT
##First plot sets the limits of the map!
Main <- plot(CH_borders, lwd=1.5, xlim=c(6,11), ylim=c(45,48), col="gray85")
...
points(9.55, 46.783333, pch=24, bg="yellow", cex=2) #Churwalden

library(maps)
map.scale(ratio=F, x=8, y=45.2, cex=1)
detach(package: maps)

library(GISTools)
north.arrow(xb=7.3, yb=45.2, len=0.05, lab="N", col="black", cex=1.3)
