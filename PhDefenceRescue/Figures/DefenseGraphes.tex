...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\textwidth]{figure/lrssimul-1} 

\includegraphics[width=\textwidth]{figure/lrssimul-2} 
\begin{kframe}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in arrows(x0 = x, y0 = CIyL, y1 = CIyH, angle = 90, col = "{}white"{}, : zero-length arrow is of indeterminate angle and so skipped}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in arrows(x0 = x, y0 = CIyL, y1 = CIyH, angle = 90, col = "{}white"{}, : zero-length arrow is of indeterminate angle and so skipped}}\end{kframe}
\includegraphics[width=\textwidth]{figure/lrssimul-3} 
