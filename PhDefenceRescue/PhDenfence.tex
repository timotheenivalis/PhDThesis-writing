...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%% Doc info %%%%%%%%%%%%%%%%%%%
\title[\textbf{Variation in fitness}]{\textbf{Individual-level causes and population-level consequences of variation in fitness in an Alpine rodent}}
...
\uncover<2->{
	...
	\end{figure}}%not restricted to this sample of humans, but virtually observed in all populations
...
%at the basis of Evolutionary biology, why are there differences? 
% Why are they maintained? Why does not the best phenotype invade?
%only recently did we start to have the tools to measure the respective roles of
% genetic variation, the environment, and chance and we still don't know much about natural populations.

\begin{frame}{Variation in fitness}

	\only<2>{ \begin{figure} 
			\begin{tikzpicture}
				\node (pic) at (0,0) {\includegraphics[width = \textwidth]{Figures/fitness}};
				\draw[color=red, thick] ($(pic.135)+(-0.2,0.2)$)--($(pic.315)+(0.2,-0.2)$);
				\draw[color=red, thick] ($(pic.225)+(-0.2,-0.2)$)--($(pic.45)+(0.2,0.2)$);
				\end{tikzpicture}
	\end{figure}}
	
		\only<3>{ \begin{figure} 
		\includegraphics[width = \textwidth]{Figures/pepper}
	\end{figure}}
	
		\only<4>{ \begin{figure} 
		\includegraphics[width = \textwidth]{Figures/finches}
	\end{figure}}
	
	\only<5>{
		\begin{alertblock}{Fitness}
...
\begin{frame}{Variation in fitness}
	\begin{figure}
		\uncover<1->{\includegraphics[width=0.48\textwidth,height=0.36\textwidth]{Figures/babyTurtle} \hspace{1pt}}
		\uncover<2->{\includegraphics[width=0.48\textwidth,height=0.36\textwidth]{Figures/adultTurtle}}
		\vspace{1pt}
		\uncover<3->{\includegraphics[width=0.48\textwidth,height=0.36\textwidth]{Figures/BlueTits2}\hspace{1pt}}
		\uncover<4->{\includegraphics[width=0.48\textwidth,height=0.36\textwidth]{Figures/BlueTits8}}
	\end{figure}
	
	
\end{frame}
%%%%%%%%%%%
% variation in fitness can come from survival or repro

%%
\begin{frame}{Variation in fitness \alert{matters}}
\begin{block}{Why variation?}

\end{block}


\begin{block}{Adaptation}
Additive genetic variation in fitness \alert{\large =} evolution
	\begin{figure}
		\begin{tikzpicture}
...
\uncover<1->{\node[] (a) at ($(Abb.north)+(-1,-0.25)$){\textbf{\large Simulate data}};}

\uncover<5->{\node[] (b) at ($(Bbb.north)+(-0.25,-0.25)$) {\textbf{\large Test fixed heterogeneity}};}
...
\draw[->, shorten >= 2pt] (test.270) to (error.70);}
...
\end{block}
	...
	\uncover<4->{\begin{block}{Implications}
		\begin{itemize}
			\uncover<5->{\item Phenotypic variation in latent fitness
				\begin{itemize}
					\item Opportunity for selection
					\item Adaptive potential
					\end{itemize}}
		\end{itemize}
	\end{block}}
...
\begin{frame}{The animal model}
	\begin{figure}
		\begin{tikzpicture}
		\coordinate (sDNA) at (-0.5,-0.5);
		\coordinate (sENV) at (0.5,-0.5);
			\node[anchor=south] (vole1) at (0,0) {\includegraphics[width = 0.075\textwidth]{Figures/snowwwvole2.pdf}};
			\node[anchor=south] (vole2) at (2.5,0) {\includegraphics[width = 0.06\textwidth]{Figures/snowwwvole2.pdf}};
			\node[anchor=south] (vole3) at (5,0) {\includegraphics[width = 0.045\textwidth]{Figures/snowwwvole2.pdf}};
			\node[anchor=south] (vole4) at (7.5,0) {\includegraphics[width = 0.03\textwidth]{Figures/snowwwvole2.pdf}};
			
			\uncover<2-4>{\node[anchor=north] (dna1) at ($(vole1.south)+(sDNA)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};}
			\uncover<3-4>{\node[anchor=north] (env1) at ($(vole1.south)+(sENV)$) {\includegraphics[width = 0.1\textwidth]{Figures/GrassGreen.png}};}
			
			\uncover<4>{\node[anchor=north] (dna2) at ($(vole2.south)+(sDNA)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env2) at ($(vole2.south)+(sENV)$) {\includegraphics[width = 0.08\textwidth]{Figures/GrassGreen.png}};
		
			\node[anchor=north] (dna3) at ($(vole3.south)+(sDNA)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env3) at ($(vole3.south)+(sENV)$) {\includegraphics[width = 0.06\textwidth]{Figures/GrassGreen.png}};
			
			\node[anchor=north] (dna4) at ($(vole4.south)+(sDNA)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env4) at ($(vole4.south)+(sENV)$) {\includegraphics[width = 0.04\textwidth]{Figures/GrassGreen.png}};}
		
		\uncover<4->{
		\foreach \x in {1,...,4}
			{
				\draw[->, color=OwlYellow, thick] (dna\x) -- (vole\x);
				\draw[->, color=OwlGreen, thick] (env\x) -- (vole\x);
			} }
	\uncover<5>{
			\node[anchor=north] (dna12) at ($(vole1.south)+(sDNA)$) {\includegraphics[width = 0.1\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env12) at ($(vole1.south)+(sENV)$) {\includegraphics[width = 0.07\textwidth]{Figures/GrassGreen.png}};
			\node[anchor=north] (dna22) at ($(vole2.south)+(sDNA)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env22) at ($(vole2.south)+(sENV)$) {\includegraphics[width = 0.07\textwidth]{Figures/GrassGreen.png}};
		
			\node[anchor=north] (dna32) at ($(vole3.south)+(sDNA)$) {\includegraphics[width = 0.06\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env32) at ($(vole3.south)+(sENV)$) {\includegraphics[width = 0.07\textwidth]{Figures/GrassGreen.png}};
			
			\node[anchor=north] (dna42) at ($(vole4.south)+(sDNA)$) {\includegraphics[width = 0.04\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env42) at ($(vole4.south)+(sENV)$) {\includegraphics[width = 0.07\textwidth]{Figures/GrassGreen.png}};}
			
				\uncover<6>{
			\node[anchor=north] (dna13) at ($(vole1.south)+(sDNA)$) {\includegraphics[width = 0.1\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env13) at ($(vole1.south)+(sENV)$) {\includegraphics[width = 0.1\textwidth]{Figures/GrassGreen.png}};
			\node[anchor=north] (dna23) at ($(vole2.south)+(sDNA)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env23) at ($(vole2.south)+(sENV)$) {\includegraphics[width = 0.08\textwidth]{Figures/GrassGreen.png}};
		
			\node[anchor=north] (dna33) at ($(vole3.south)+(sDNA)$) {\includegraphics[width = 0.06\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env33) at ($(vole3.south)+(sENV)$) {\includegraphics[width = 0.06\textwidth]{Figures/GrassGreen.png}};
			
			\node[anchor=north] (dna43) at ($(vole4.south)+(sDNA)$) {\includegraphics[width = 0.04\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env43) at ($(vole4.south)+(sENV)$) {\includegraphics[width = 0.04\textwidth]{Figures/GrassGreen.png}};}
		\end{tikzpicture}
	\end{figure}
\end{frame}
%%%%%%%%%%%
...
\begin{figure}
			\begin{tikzpicture}[
				...
				first/.style={level distance=20pt},
				level 1/.style={sibling distance=30pt}]
				%level 2/.style={sibling distance=15pt}]
					% Parents

					\coordinate (family1) at (0,0)
						child[grow=left,level distance=10pt]{node[man,anchor=east]{\includegraphics[width = 0.1\textwidth]{Figures/snowwwvole2.pdf}}}
						child[grow=right,level distance=10pt]{node[woman,anchor=west]{\includegraphics[width = 0.08\textwidth]{Figures/snowwwvole2.pdf}}}
						child[grow=down,level distance=2.5ex]
					[edge from parent fork down]
					% Children and grandchildren
					child{node[man] {\includegraphics[width = 0.055\textwidth]{Figures/snowwwvole2.pdf}}}
					child{node[woman] {\includegraphics[width = 0.06\textwidth]{Figures/snowwwvole2.pdf}}}
					child {node[man] {\includegraphics[width = 0.045\textwidth]{Figures/snowwwvole2.pdf}}}
					child {node[woman] {\includegraphics[width = 0.058\textwidth]{Figures/snowwwvole2.pdf}}}
					child {node[woman] {\includegraphics[width = 0.049\textwidth]{Figures/snowwwvole2.pdf}}};
				
					\coordinate (family2) at (5,0)
						child[grow=left,level distance=10pt]{node[man,anchor=east]{\includegraphics[width = 0.06\textwidth]{Figures/snowwwvole2.pdf}}}
						child[grow=right,level distance=10pt]{node[woman,anchor=west]{\includegraphics[width = 0.04\textwidth]{Figures/snowwwvole2.pdf}}}
						child[grow=down,level distance=2.5ex]
					[edge from parent fork down]
					% Children and grandchildren
					child{node[man] {\includegraphics[width = 0.021\textwidth]{Figures/snowwwvole2.pdf}}}
					child{node[man] {\includegraphics[width = 0.031\textwidth]{Figures/snowwwvole2.pdf}}}
					child {node[woman] {\includegraphics[width = 0.026\textwidth]{Figures/snowwwvole2.pdf}}};

			\uncover<2->{
					\node[anchor=south] (dna1) at ($(family1.north) + (0,1)$) {\includegraphics[width = 0.1\textwidth]{Figures/dnaOrange.png}};
					\node[anchor=south] (dna2) at ($(family2.north) + (0,1)$) {\includegraphics[width = 0.04\textwidth]{Figures/dnaOrange.png}};}
				\end{tikzpicture}
		\end{figure}
...
\begin{figure}	
	\begin{tikzpicture}
					\uncover<3->{
			\node[] (env0) at (0,0) {\includegraphics[width = 0.1\textwidth]{Figures/GrassGreen.png}};
			\node (eq) at ($(env0) + (1,0)$) {\LARGE =};
			\node[] (sv0) at ($(env0) + (2,0)$) {\includegraphics[width = 0.07\textwidth]{Figures/snowwwvole2.pdf}};
			\node (eq) at ($(sv0) + (1,0)$) {\LARGE -};
			\node[] (dna0) at ($(sv0) + (2,0)$){\includegraphics[width = 0.07\textwidth]{Figures/dnaOrange.png}};
			}
		\end{tikzpicture}
	\end{figure}
\end{frame}
...
\begin{frame}{The animal model}
	\begin{figure}
		...
		\coordinate (sENV) at (0.5,-0.5);
			...
			\node[anchor=north] (dna1) at ($(vole1.south)+(sDNA)$) {\includegraphics[width = 0.1\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env1) at ($(vole1.south)+(sENV)$) {\includegraphics[width = 0.1\textwidth]{Figures/GrassGreen.png}};
			\node[anchor=north] (dna2) at ($(vole2.south)+(sDNA)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env2) at ($(vole2.south)+(sENV)$) {\includegraphics[width = 0.08\textwidth]{Figures/GrassGreen.png}};
		
			\node[anchor=north] (dna3) at ($(vole3.south)+(sDNA)$) {\includegraphics[width = 0.06\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env3) at ($(vole3.south)+(sENV)$) {\includegraphics[width = 0.06\textwidth]{Figures/GrassGreen.png}};
			
			\node[anchor=north] (dna4) at ($(vole4.south)+(sDNA)$) {\includegraphics[width = 0.04\textwidth]{Figures/dnaOrange.png}};
			\node[anchor=north] (env4) at ($(vole4.south)+(sENV)$) {\includegraphics[width = 0.04\textwidth]{Figures/GrassGreen.png}};
...
\uncover<1->{
	...
	\textbf{Additive Genetic Variance}
	\end{column}
	\begin{column}[c]{0.15\textwidth}
	{\LARGE $ = \large V_A$}
	\end{column}
	\begin{column}[c]{0.6\textwidth}
		\begin{tikzpicture}
			\node (e) at (0,0) {\LARGE=};
			\node (t) at ($(e)+(1.2,0.1)$) {\large variance};
			\node (b1) at ($(t.east)+(0.1,0)$) {\LARGE (};
			\node (d1) at ($(t.east)+(0.5,0)$) {\includegraphics[width = 0.06\textwidth]{Figures/dnaOrange.png}};
			\node (d2) at ($(d1.east)+(0.5,0)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node (d3) at ($(d2.east)+(0.5,0)$) {\includegraphics[width = 0.04\textwidth]{Figures/dnaOrange.png}};
			\node (d4) at ($(d3.east)+(0.5,0)$) {\includegraphics[width = 0.1\textwidth]{Figures/dnaOrange.png}};
			\node (b2) at ($(d4.east)+(0.1,0)$) {\LARGE )};
		\end{tikzpicture}
	\end{column}
	\end{columns}}
	...
	\uncover<2->{
		\begin{columns}
	\begin{column}[c]{0.25\textwidth}
	\textbf{Heritability} \LARGE $  = h^2$
		\end{column}
	\begin{column}[c]{0.15\textwidth}
	{\LARGE $= \frac{V_A}{V_P}$}
	\end{column}
	\begin{column}[c]{0.6\textwidth}		\begin{tikzpicture}
			\node (e) at (0,0) {\LARGE=};
			\node (t) at ($(e)+(1.2,0.6)$) {\large variance};
			\node (b11) at ($(t.east)+(0.1,0)$) {\LARGE (};
			\node (d1) at ($(t.east)+(0.5,0)$) {\includegraphics[width = 0.06\textwidth]{Figures/dnaOrange.png}};
			\node (d2) at ($(d1.east)+(0.5,0)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node (d3) at ($(d2.east)+(0.5,0)$) {\includegraphics[width = 0.04\textwidth]{Figures/dnaOrange.png}};
			\node (d4) at ($(d3.east)+(0.5,0)$) {\includegraphics[width = 0.1\textwidth]{Figures/dnaOrange.png}};
			\node (b21) at ($(d4.east)+(0.1,0)$) {\LARGE )};

			\draw[thick] ($(e.east)+(0.2,0.1)$) -- ($(e.east)+(5.5,0.1)$);
			
			\node (t2) at ($(e)+(1.2,-0.5)$){\large variance};
			\node (b12) at ($(t2.east)+(0.1,0)$) {\LARGE (};
			\node (v1) at ($(t2.east)+(0.5,0)$) {\includegraphics[width = 0.08\textwidth]{Figures/snowwwvole2.pdf}};
			\node (v2) at ($(v1.east)+(0.5,0)$) {\includegraphics[width = 0.1\textwidth]{Figures/snowwwvole2.pdf}};
			\node (v3) at ($(v2.east)+(0.5,0)$) {\includegraphics[width = 0.04\textwidth]{Figures/snowwwvole2.pdf}};
			\node (v4) at ($(v3.east)+(0.5,0)$) {\includegraphics[width = 0.06\textwidth]{Figures/snowwwvole2.pdf}};
			\node (b22) at ($(v4.east)+(0.1,0)$) {\LARGE )};
		\end{tikzpicture}
		\end{column}
	\end{columns}}
	...
	\begin{column}[c]{0.6\textwidth}
		\begin{figure}
			\begin{tikzpicture}
				\coordinate (EvOr) at (0,0);
				\coordinate (EvX) at (4,0);
				\coordinate (EvY) at (0,1.5);
				\draw[->,thick] (EvOr)--(EvX);
			\draw[->,thick,color=OwlYellow] (EvOr)--(EvY);
			\node[anchor=north] (EvlabX) at (EvX) {\large Time};
			\node[anchor=east] (EvlabY) at ($(EvY)+(0.1,-0.2)$) {\includegraphics[width=0.6cm]{Figures/dnaOrange}};
			\node[anchor=east] (EvlabY) at ($(EvOr)+(0,0)$) {\includegraphics[width=0.3cm]{Figures/dnaOrange}};

			\draw[color=red, thick] ($(EvY)+(0.1,-0.2)$)--($(EvX)+(-0.1,0.2)$);
			\end{tikzpicture}
		\end{figure}
	\end{column}
\end{columns}}
...
\begin{block}{Adaptive evolution in the snow vole?}
	...
	\end{itemize}
	\centering
	\uncover<5->{\textbf{\alert{Ongoing evolution and opportunity for selection}}}
\end{block}
