...
\begin{columns}
	\begin{column}[c]{0.35\textwidth}
		...
		%committee
			\item Lukas Keller
			\item Barbara Tschirren
			\item Arpat Ozgul
			\item Marc Kéry 
			\item Jarrod Hadfield
		%colleagues
			\item Glauco Camenisch
			\item Ursina Tobler
			\item Dominique Waldvogel
			\item Martina Schenkel
			\item Vicente Garc{\'{i}}a-Navas
			\item Andres Hagmayer
			\item Koen van Benthem
			\item Marjolein Bruijning
			\item Eelke Jongejans
			\item Pirmin Nietlisbach
			\item Philipp Becker
			\item Judith Bachmann
