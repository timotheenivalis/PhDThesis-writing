	...
	\begin{column}[c]{0.7\textwidth}
		...
		\begin{figure}[c]
			\begin{tikzpicture}
				...
				\uncover<3->{\node (lukas) at (1.2,0) {\includegraphics[width = 0.15 \textwidth]{Figures/Lukas}};
				\node (barbara) at (2.2,0) {\includegraphics[width = 0.15 \textwidth]{Figures/Barbara}};
				\node (arpat) at (3.5,0) {\includegraphics[width = 0.2 \textwidth]{Figures/Arpat}};
				\node (marc) at (4.7,0) {\includegraphics[width = 0.2 \textwidth]{Figures/Marc}};
				\node (jarrod) at (6,0) {\includegraphics[width = 0.2\textwidth]{Figures/Jarrod}};}
				\uncover<4->{\node (glauco) at (0,-1.4) {\includegraphics[width = 0.22 \textwidth]{Figures/Glauco}};}
				\uncover<5->{\node (ursina) at (1.2,-1.4) {\includegraphics[width = 0.20 \textwidth]{Figures/Ursina}};}
				\uncover<6->{\node (domi) at (2.4,-1.4) {\includegraphics[width = 0.20 \textwidth]{Figures/Domi}};}
				\uncover<6->{\node (martina) at (3.6,-1.4) {\includegraphics[width = 0.20 \textwidth]{Figures/Martina}};}
