...
\begin{frame}{The animal model}
	...
	\begin{column}[c]{0.8\textwidth}
		\begin{tikzpicture}
			\node (t) at (0,0) {\large= variance};
			
			\node (d1) at ($(t.east)+(0.5,0)$) {\includegraphics[width = 0.1\textwidth]{Figures/dnaOrange.png}};
			\node (d2) at ($(d1.east)+(0.5,0)$) {\includegraphics[width = 0.08\textwidth]{Figures/dnaOrange.png}};
			\node (d3) at ($(d2.east)+(0.5,0)$) {\includegraphics[width = 0.06\textwidth]{Figures/dnaOrange.png}};
			\node (d4) at ($(d3.east)+(0.5,0)$) {\includegraphics[width = 0.04\textwidth]{Figures/dnaOrange.png}};
		\end{tikzpicture}
	\end{column}
	\end{columns}
	...
	\textbf{Heritability} 
		\end{column}
	\begin{column}[c]{0.8\textwidth}		\begin{tikzpicture}
			\node (e) at (0,0) {\LARGE=};
			\node (t) at (0,1) {\large variance};
			...
			\draw ($(e.east)+(0.2,0)$) -- ($(e.east)+(5,0)$);
			
			\node (t2) at (0,-1) {\large variance};
			\node (v1) at ($(t2.east)+(0.5,0)$) {\includegraphics[width = 0.1\textwidth]{Figures/snowwwvole2.pdf}};
			\node (v2) at ($(v1.east)+(0.5,0)$) {\includegraphics[width = 0.08\textwidth]{Figures/snowwwvole2.pdf}};
			\node (v3) at ($(v2.east)+(0.5,0)$) {\includegraphics[width = 0.06\textwidth]{Figures/snowwwvole2.pdf}};
			\node (v4) at ($(v3.east)+(0.5,0)$) {\includegraphics[width = 0.04\textwidth]{Figures/snowwwvole2.pdf}};
