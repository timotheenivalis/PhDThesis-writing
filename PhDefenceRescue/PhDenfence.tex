...
Pedigree $\rightarrow$ similarity between relatives $\rightarrow$ additive genetic variance
\begin{equation*}
\text{heritability} = \frac{\text{additive genetic variance}}{\text{phenotypic variance}} 
\end{equation*}
