...
%bibliography
\usepackage[backend=biber, doi=false, authordate]{biblatex-chicago}
%\urlstyle{sf} % better deals with url breaks
\newcommand{\citep}[1]{\parencite{#1}}% to keep the natbib syntax

%\bibliographystyle{amnat}%Compile with amnat.bst style file
